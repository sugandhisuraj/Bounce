...
export default class TapRating extends Component {
  ...
  componentDidMount() {
    const { defaultRating,StarSize,reviewTime } = this.props

    this.setState({ position: defaultRating,reviewTime:reviewTime })
  }
  ...
  render() {
    ...
    return (
      <View style={styles.ratingContainer}>
        ...
        {
          this.state.reviewTime ?   <Text style={styles.ReviewTime}> 4 months ago</Text> : null
        }
        </View>
      </View>
    );
